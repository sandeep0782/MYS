...
const addToWishlist = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let wishlist = yield Wishlist_1.Wishlist.findOne({ user: userId });
        if (!wishlist) {
            wishlist = new Wishlist_1.Wishlist({ user: userId, products: [] });
        }
        ...
        console.error(error);
        return (0, responseHandler_1.response)(res, 500, "Server Error", error.message);
    }
});
...
const removeFromWishlist = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield wishlist.save();
        return (0, responseHandler_1.response)(res, 200, "Product Removed from Wishlist");
    }
    catch (error) {
        console.error(error);
        return (0, responseHandler_1.response)(res, 500, "Server Error", error.message);
...
const getWishlistByUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const wishlist = yield Wishlist_1.Wishlist.findOne({ user: userId }).populate("products");
        if (!wishlist) {
            return (0, responseHandler_1.response)(res, 404, "wishlist is empty", { products: [] });
        }
        return (0, responseHandler_1.response)(res, 200, "wishlist fetched successfully", wishlist);
    }
    catch (error) {
        console.error(error);
        return (0, responseHandler_1.response)(res, 500, "Server Error", error.message);
