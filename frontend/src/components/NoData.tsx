    ...
    return (
        <div className="flex flex-col items-center justify-center p-6 bg-white overflow-x-hidden space-y-6 mx-auto">
            ...
            {onClick && (
                <button
                    onClick={onClick}
                    className="px-6 w-60 py-2 bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-300 text-white font-medium rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transform transition duration-300 ease-in-out cursor-pointer"
                >
                    {buttonText}
                </button>
            )}
