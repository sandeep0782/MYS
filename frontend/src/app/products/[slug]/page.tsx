...
const page = () => {
    ...
    useEffect(() => {
        if (apiResponse?.success && apiResponse?.data) {
            ...
            console.log("Sizes Array Example:", apiResponse.data.sizes[0]); // <-- log the first size
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="space-y-2">
                                ...
                                <h1 className="text-gray-500 text-2xl font-semibold">{product.name}</h1>
                            ...
                            <div className="flex gap-2">
                                <ShareButton
                                    ...
                                    text={`I found a beautiful product on MYSMME:${product.name}`}
                                />
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                */}
                                <Button
                                    className={`flex-[0.6] py-6 flex items-center justify-center cursor-pointer transition-colors ${isInCart ? "bg-green-600 hover:bg-green-700" : "bg-blue-700 hover:bg-blue-800"
                                        }`}
                                    onClick={() => {
                                        if (isInCart) {
